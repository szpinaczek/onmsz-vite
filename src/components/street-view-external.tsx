...
const StreetViewExternal: React.FC<StreetViewProps> = ({
  isVisible,
  onClose,
  position,
  language,
  ...
  useEffect(() => {
    if (isVisible && position) {
      const url = `/google-street-view.html?lat=${position.lat}&lng=${position.lng}&key=${apiKey}`;
      setIframeUrl(url);
      setIsLoading(true);
...
export default StreetViewExternal;
